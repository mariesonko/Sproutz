...
family2 = Family.create(title: 'Amundson', username: 'AmundsonFamily', password:'amundson123')
 ...
 cecilia = Parent.create(family_id: 1, firstName: 'Cecilia', lastName: 'Taylor', cellPhone: '7183478978', dateOfBirth: '01231984', gender: 'female', address: '23 court street', city: 'Brooklyn', state: 'NY', zipCode: '11213', email: 'cecilia@gmail.com')

lori = Parent.create(family_id: 2, firstName: 'Lori', lastName: 'Amundson', cellPhone: '7185552345', dateOfBirth: '09231983', gender: 'female', address: '17 prince street', city: 'Brooklyn', state: 'NY', zipCode: '11221', email: 'lori@gmail.com')


marius = Child.create(family_id: 1, childFirstName: 'Marius', childLastName: 'Smith', childGender: 'male', childDateOfBirth: '08182015', medicalConditions: 'none')

paige = Child.create(family_id: 2, childFirstName: 'Paige', childLastName: 'Blake', childGender: 'female', childDateOfBirth: '07182016', medicalConditions: 'none')
...
playdate2 = Playdate.create(host_id: 2, guest_id: 1, event_id: 2, date: '08/08/2018', startTime: '12:00pm', endTime: '5:00pm')

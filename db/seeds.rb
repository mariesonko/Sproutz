...
family2 = Family.create(title: 'Amundson')
 ...
 cecilia = Parent.create(family_id: 1, firstName: 'Cecilia', lastName: 'Taylor', cellPhone: '7183478978', dateOfBirth: '01231984', gender: 'female', address: '23 court street', city: 'Brooklyn', state: 'NY', zipCode: '11213', email: 'cecilia@gmail.com', password: 'cecilia123')

lori = Parent.create(family_id: 2, firstName: 'Lori', lastName: 'Amundson', cellPhone: '7185552345', dateOfBirth: '09231983', gender: 'female', address: '17 prince street', city: 'Brooklyn', state: 'NY', zipCode: '11221', email: 'lori@gmail.com', password: 'lori123')


marius = Child.create(family_id: 1, firstName: 'Marius', lastName: 'Smith', gender: 'male', dateOfBirth: '08182015', medicalConditions: 'none')
